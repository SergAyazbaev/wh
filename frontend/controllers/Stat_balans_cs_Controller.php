...
//        }
    ...
    public static function Math_summary($array_inventary, $arrayPrihodRashod)
    {
        ...
        ///  ЛОГИКА 1.
        ///
        ///  Проход- вычитание расходов из массива Инвентаризации
...
//                        ddd($item_PR['date']);
                        ...
                        if (isset($item_PR['bar_code']) && !empty($item_PR['bar_code']) && $item_PR['bar_code'] === $item_inventary['bar_code']) {
                            ...
                            //В первом случае это без учета даты установки!!! ЕЕ сюда не передаем
                ...
                if ($item_PR['wh_tk_amort'] === $item_minimal['wh_tk_amort'] && $item_PR['wh_tk_element'] === $item_minimal['wh_tk_element']) {
                    ...
                    if (isset($item_PR['plus_minus']) && $item_PR['plus_minus'] == 2) {
                        ...
                        if (isset($item_PR['bar_code']) && !empty($item_PR['bar_code']) && $item_PR['bar_code'] == $item_minimal['bar_code']) {
                            ...
                            if (isset($item_minimal['dt_create_plus']) &&
                                $item_minimal['dt_create_plus'] <= $item_PR['date']) {
...
//                            break;
     ...
     * @return mixed
     */
    public static function ArrayPrihodRashod_v2($sklad_id, $dt_create_timestamp = 0)
    {
