...
class Stat_svod_whController extends Controller
{
    public $sklad;
...
//            ddd($dataProvider->getModels());
            ...
            //        'wh_destination' => 3
            //        'wh_destination_name' => 'Guidejet TI. Склад инженеров эксплуатации'
            //        'wh_destination_element' => 4431
            //        'wh_destination_element_name' => 'Дежурный'
            //        'sklad_vid_oper_name' => null
            //        'tz_id' => null
            //        'dt_create' => '15.06.2020 10:21:09'
            //        'dt_update' => null
            //        'array_bus' => null
            //        'array_count_all' => null
            //        'dt_transfered_date' => null
            //        'wh_tk_amort' => 'Оборудование АСУОП'
            //        'wh_tk_element' => 'Промышленный Ethernet-коммутатор IES1005 (Китай) (Switch ZTE IES1005 5port)'
            //        'ed_izmer' => '1'
            //        'ed_izmer_num' => '1'
            //        'bar_code' => '1510080390'
            //        'wh_tk_amort_id' => '7'
    ...
    /**
     *  Сводная таблица по всем ИНВЕНТАРИЗАЦИЯМ
     * -
     *
     * @return string
     */
    public function actionIndex_svod_wh()
    {
...
//        }
        ...
        //
        $filer_cs = Sklad::Array_wh();
        //
        $para = Yii::$app->request->get('postsklad_inventory_cs');
        //* Даты Инвентаризаций
        if (isset($para['wh_destination']) && !empty($para['wh_destination'])) {
            $filter_for_date = Sklad_wh_invent::ArrayUniq_dates_byAP($para['wh_destination']);
        } else {
            $filter_for_date = Sklad_wh_invent::ArrayUniq_dates_byAP(0);
        }
...
//        $model['array_tk'] = $this->getTkNames((isset($model['array_tk']) ? $model['array_tk'] : []));
    ...
    function Stolb_A_Day($first_number = 0)
    {
        if ($first_number == 0) {
            ...
            ///
            $array_first_date = Sklad_wh_invent::find()
...
//        ddd($date_start);
        ...
        ///
        $count_all = Sklad_wh_invent::find()
