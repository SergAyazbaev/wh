...
$form = ActiveForm::begin([
    'method' => 'GET',
    //'action' => 'from_cs',
    /// actionCreate_new_from_cs
    'action' => 'create_new_from_cs',
...
JS
                    ...
                    'items' => ArrayHelper::map(Spr_globam_element::find()->orderBy('name')->all(), 'id', 'name')
                ],
...
//JS
        ...
        ])->label('АСУОП', ['class' => 'my_label']);

        ?>

        <div id="itogo"> Итого: <?= $itogo ?> шт.</div>
    </div>
