    ...
    <div class="pv_motion_create_ok_button">
        ...
        <div class="name_ss">
            ...
            <div class="name_s1" style="width: 45%">
                ...
                <!--                --><? //= $form->field($new_doc, 'erase_array[1][1]')->textInput(['placeholder' => '(' . $erase_array[1] . ')', 'autofocus' => true, 'style' => 'width: 120px'])->label(false); ?>
            </div>
        </div>
        ...
        <div class="name_ss">
            ...
            <div class="name_s1" style="width: 45%">
                ...
                <!--                --><? //= $form->field($new_doc, 'erase_array[2][1]')->textInput(['placeholder' => '(' . $erase_array[2] . ')', 'autofocus' => true, 'style' => 'width: 120px'])->label(false); ?>
            </div>
        </div>
