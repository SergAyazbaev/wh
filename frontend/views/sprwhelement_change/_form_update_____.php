...
<div id="tz1">
    <div class="pv_motion_create_right_center">
        ...
        <div class="tree_land">
            <?php
            echo $form->field($model, 'doc_num');

            echo $form->field($model, 'doc_cr')
                ->widget(DatePicker::className(), [
        ...
        <div class="tree_land">
            <?php
            echo $form->field($model, 'old_bort');
            echo $form->field($model, 'n_bort');
            ?>
        </div>

        <div class="tree_land">
            <?php
            echo $form->field($model, 'old_gos');

            echo $form->field($model, 'n_gos');
    ...
    <div class="pv_motion_create_ok_button">
        ...
        <?php
        echo Html::a('Выход', ['/sprwhelement_change/index'], ['class' => 'btn btn-warning']);
        ?>
