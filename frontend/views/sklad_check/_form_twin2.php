...
Для Монтажной накладной используются те же данные, но в обратном порядке. Поэтому заполняйте так, как для Демонтажа.
...
JS
    ...
    ])->label('Монтаж АСУОП', ['class' => 'my_label']);;
    ?>
</div>
