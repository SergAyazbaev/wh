...
<div class="site-index">
    ...
    <!---->
    <!--    <h2><b> Монтаж </b></h2>-->
    <!--    <h2> Буферные позиции установка, очередь</h2>-->
    <!---->
    <!--    <div class="mobile-body-content">-->
    <!--        <div class="scroll_mobile">-->
    <!--            --><?php
    //            $dataProvider_montage->pagination->pageParam = 'sklad-page';
    //            $dataProvider_montage->sort->sortParam = 'sklad-sort';
    //
    //            //            $dataProvider_montage->setSort(
    //            //                [
    //            //                    'defaultOrder' => ['id' => SORT_DESC],
    //            //                ]);
    //            //            $dataProvider_montage->pagination->pageSize = 10;
    //
    //            echo GridView::widget(
    //                [
    //                    'dataProvider' => $dataProvider_montage,
    //                    'filterModel' => $searchModel_montage,
    //
    //                    'showFooter' => false,    // футер
    //                    'showHeader' => true,  // заголовок
    //                    'summary' => false,     // всего из ..
    ...
    //
    //                            'content' => function ($model) {
    //                                if ((int)$model->job_fin_timestamp > 0) {
    //                                    return 'Да';
    //                                } else {
    //                                    return 'Нет';
    //                                }
    ...
    <!--    <br>-->
    <!--    <h2><b> Монтаж </b></h2>-->
    <!--    <h2>Законченые позиции</h2>-->
    <!---->
    <!--    <div class="mobile-body-content">-->
    <!---->
    <!--        <div class="scroll_mobile">-->
    <!--            --><? //
    //            $dataProvider_close->pagination->pageParam = 'close-page';
    //            $dataProvider_close->sort->sortParam = 'close-sort';
    //
    //            //            $dataProvider_close->setSort(
    //            //                [
    //            //                    'defaultOrder' => ['id' => SORT_DESC],
    //            //                ]);
    //            //            $dataProvider_close->pagination->pageSize = 10;
    //
    //            echo GridView::widget(
    //                [
    //                    'dataProvider' => $dataProvider_close,
    //                    'filterModel' => $searchModel_close,
    //
    //                    'showFooter' => false,    // футер
    //                    'showHeader' => true,  // заголовок
    //                    'summary' => false,     // всего из ..
