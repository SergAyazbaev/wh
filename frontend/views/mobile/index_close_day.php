...
<div class="site-index">
    <div class="mobile-body-content">
        ...
        <h5><b> Закрытие дня. </b></h5>
        <h5><b> Возврат остатков Дежурному складу.</b></h5>


        <div class="width_all_butt">

            <?= Html::a('Закрытие дня', ['/mobile_close_day/close_a_day'],
                [
                    'class' => 'width_all btn btn-danger',
                    'data' => [
                        'confirm' => 'День закроется безвозвратно. Закрываем ?',
                        'method' => 'post',
                    ],
                ]) ?>
        </div>
        ...
        <div class="_futer">
            ...
            <div class="next_futer">
                ...
                <?= Html::a('Далее >>', ['mobile/index_tree'], ['class' => ' next_step btn btn-success']) ?>
