...
$activeSheet->setCellValue('A2', 'Справочник. УМЦ Списание');
...
$activeSheet->setCellValue('A4', 'Id');
$activeSheet->setCellValue('B4', 'parent_id');
$activeSheet->setCellValue('C4', 'Наименование');
$activeSheet->setCellValue('D4', 'Ед.Изм');
$activeSheet->setCellValue('E4', '1C');
//$activeSheet->setCellValue('F4', 'Коментарии');
...
foreach ($dataModels as $ii ) {
    ...
    $activeSheet->setCellValue('B' . ($num + 5), $ii['spr_glob']['name']);
    $activeSheet->setCellValue('C' . ($num + 5), $ii['name']);
    if (isset($things[$ii['ed_izm']]))
        $activeSheet->setCellValue('D' . ($num + 5), $things[$ii['ed_izm']]);
    else
        $activeSheet->setCellValue('D' . ($num + 5), $ii['ed_izm']);

    $activeSheet->setCellValue('E' . ($num + 5), $ii['cc_id']);
//    $activeSheet->setCellValue('F' . ($num + 5), $ii['tx']);
