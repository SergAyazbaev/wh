...
<div id="tz1">
    ...
    <div class="pv_motion_create_ok_button">
        ...
        <?php
        echo Html::a('Выход', ['/sklad_inventory_cs'], ['class' => 'btn btn-warning']);
        ?>
...
///  
$('#sklad_inventory_cs-dt_create').change(function() {    
    $("#sklad_inventory_cs-wh_destination").val('');
    $("#select2-sklad_inventory_cs-wh_destination_element-container").html('');
    
});


//////////////////// Debitor -top
$('#sklad_inventory_cs-wh_destination').change(function() {
        
    var  number = $(this).val();    
    var actualdate = $('#sklad_inventory_cs-dt_create').val(); // 30.11.2020 23:59:59

    //console.log(actualdate);

    $.ajax( {
		url: '/inventory_cs_generator/list_element_cs',
		data: {
		    id :number,
		...
		//dataType: "json",		
			success: function(res) {		 
		            //$('#sklad_inventory_cs-wh_destination_element').html('');
		            //$('#sklad_inventory_cs-wh_destination_element').html(res);		    
		            $('#sklad_inventory_cs-wh_destination_element').html(res);		    
					},
			error: function( res) {
						alert('JS.sklad_inventory_cs-wh_destination == '+res );
						console.log(res);
					}
    } );
