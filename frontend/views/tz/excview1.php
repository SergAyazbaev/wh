...
//yii::setAlias('@path_save',
//    str_replace('\\', '/', realpath(__DIR__ . DIRECTORY_SEPARATOR . '..'. DIRECTORY_SEPARATOR . '..'))
//    .'/web/reports');
//yii::setAlias('@path2',
//    str_replace('\\', '/', realpath(__DIR__ . DIRECTORY_SEPARATOR . '..'. DIRECTORY_SEPARATOR . '..'. DIRECTORY_SEPARATOR . '..'))
//    .'/vendor/');
...
yii::setAlias('@path_save', '/prod/frontend/web/reports');
yii::setAlias('@path2', '/prod/vendor/');
