...
<style>
    ...
    div.tree_land_bus {
        ...
        /* width: calc((98% - 300px)/3); */
        /*width: calc((98% - 260px) / 5);*/
            ...
            echo $form->field( $model, 'name_tz' )
                ...
                ->textarea(
                    [
                        ...
                        'style' => "margin: 0px; height: 65px; width: 288px;"
//                        'style' => 'max-width: 100%; font-size: 21px; margin: 0px; width: 192px; height: 85px;',
                    ]
                );
            ?>
            ТЗ № <?= $model->id ?>
...
//                    'disabled' => 'disabled',
    ...
    <div class="pv_motion_create_ok_button">
        ...
        if ( $model[ 'user_edit_group_id' ] == Yii::$app->getUser()->identity->group_id ) {
