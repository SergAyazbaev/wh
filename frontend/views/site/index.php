...
<div class="site-index">
    ...
    <div class="body-content">
        <div class="jumbotron">
            <h1>Wh-Cs storages</h1>
            <h3>Контроль наличия приборов учета. АСУОП</h3>
        </div>

        <div class="wrapper">

            <?php if (isset(Yii::$app->user) && Yii::$app->user->getIsGuest()) { ?>
            ...
            <?php } else { ?>
                ...
                <?php if (Yii::$app->getUser()->identity->group_id == 100) {
                    //ADMIN
                    echo '<a class="btn btn-lg btn-success" href="/site/signup">Регистрация НОВОГО пользователя</a>';
                    echo '<br><br>';
                }
                ?>
                ...
                <?php
                // ДЛЯ ВСЕХ ПОЛЬЗОВАТЕЛЕЙ. Если у пользователя есть СКЛАДЫ, ТО:
