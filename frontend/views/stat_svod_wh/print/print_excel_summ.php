...
$activeSheet->setCellValue('L4', 'Цена');
$activeSheet->setCellValue('M4', 'Название партии');
...
//    $activeSheet->setCellValue('M' . ($num + 5), $ii['wh_home_number']);
    ...
    $activeSheet->setCellValue('L' . ($num + 5), (isset($ii['part_cena_input']) ? '' . $ii['part_cena_input'] : ''));

    $activeSheet->setCellValue('M' . ($num + 5), (isset($ii['part_name']) ? '' . $ii['part_name'] : ''));
...
///// СЕТКА
$activeSheet->setSharedStyle($sharedStyle2, "A4:M" . ($num + 4));


$activeSheet->getStyle('A3')->getFont()->setBold(true);

$activeSheet->getStyle('A4:M4')->getFont()->setName('Malgun Gothic');  /// 'Candara');
$activeSheet->getStyle('A4:M4')->getFont()->setBold(true);
$activeSheet->getStyle('A4:M4')->getFont()->setSize(11);
...
//$activeSheet->getStyle('B5:B'.($num + 4))->getNumberFormat()->setFormatCode('yyyy-mm-dd h:mm:ss');
//$activeSheet->getStyle('B5:B'.($num + 4))->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_DATE_DDMMYYYY);
//$activeSheet->getStyle('B5:B'.($num + 4))->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_DATE_YYYYMMDD2);

$activeSheet->getStyle('B5:B' . ($num + 4))->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_DATE_DATETIME);
...
$activeSheet->getStyle('L5:L' . ($num + 4))->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1);
$activeSheet->getStyle('M5:M' . ($num + 4))->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_GENERAL);
