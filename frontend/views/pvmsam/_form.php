        ...
        // dd($model);
            ...
            echo '<div class="tree_land">';
                ...
                echo $form->field($model, 'wh_top')->dropdownList(
                 ...
                 echo $form->field($model, 'wh_top_name')->dropdownList(
...
$('#pvmotion-wh_top').change(function() {
    var  number = $(this).val();
    var  text = $('option[value='+number+']').text();
    
    	    $('#pvmotion-wh_top_name').val(text);
    ...
    $.ajax( {
		...
		//dataType: "json",		
		    ...
		    $('#pvmotion-wh_element').html('');
		    $('#pvmotion-wh_element').html(res);
