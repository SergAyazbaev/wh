...
<div id="tz1">
    ...
    <div class="pv_motion_create_ok_button">
        ...
        ///////////////////////
        Modal::begin([
            'header' => '<h2>Заливаем Остатки по всем ПАРКАМ. <br> Парк в парке (Администрация парка) </h2>',
            'toggleButton' => [
                'label' => 'Копипаст ПАРК-ПАРК',
                'tag' => 'button',
                'class' => 'btn btn-primary',
            ],//'footer' => 'Низ окна',
        ]);
        ?>
        <?= $form
            ->field($new_doc, 'add_text_to_inventory_park_park')
            ->textarea(['autofocus' => true,
                'style' => 'height: 300px;font-size: 12px;',
                'placeholder' => "Четыре столбца:                
                \n1. Госномер \n2. Наименование оборудования\n3. Штрихкод\n4. Количество\n [ 5. Сумма ] \n "])
        ...
        <?php
        Modal::begin([
            'header' => '<h2>Добавляем НОВЫЕ АВТОБУСЫ в справочник Складов</h2>',
            'toggleButton' => [
                'label' => 'Копипаст НОВЫЕ АВТОБУСЫ В ПАРК',
                'tag' => 'button',
                'class' => 'btn btn-info',
            ],//'footer' => 'Низ окна',
        ]);
        ...
        <?= $form
            ...
            ->textarea(['autofocus' => true,
                ...
                'placeholder' => " 
                Автопарк, Госномер,   [ Бортномер,  VIN, Примечание ]   
                Автопарк, Госномер,   [ Бортномер,  VIN, Примечание ]   
                Автопарк, Госномер,   [ Бортномер,  VIN, Примечание ]\n\n "])
            ->label(false);
        ?>
        ...
        Modal::begin([
            'header' => '<h2>Добавляем НОВЫЕ АВТОБУСЫ в справочник Складов</h2>',
            'toggleButton' => [
                'label' => 'Копипаст НОВЫЕ АВТОБУСЫ одним Столбиком',
                'tag' => 'button',
                'class' => 'btn btn-info',
            ],//'footer' => 'Низ окна',
        ]);
        ...
        <?= $form
            ...
            ->textarea(['autofocus' => true,
                'style' => 'height: 300px;font-size: 14px;',
                'placeholder' => " Автопарк выбирается в верхнем МЕНЮ\n 
                 Госномер,   [  Бортномер,  VIN, Примечание ]    
                 Госномер,   [  Бортномер,  VIN, Примечание ]    
                 Госномер,   [  Бортномер,  VIN, Примечание ]    
                 Госномер,   [  Бортномер,  VIN, Примечание ] \n 
                 "])
