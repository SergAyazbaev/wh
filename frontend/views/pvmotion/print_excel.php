...
$activeSheet->setCellValue('A2', ' Отчет. Сводная ведомость');
...
//    $activeSheet->setCellValue('L4', 'BeeLine');
    ...
    $activeSheet->setCellValue('J' . ($num + 5),  $ii['comments']);
...
$activeSheet->getStyle('A4:L4')->getFont()->setSize(14);
...
/////////////////
        ...
        $file=$_SERVER['DOCUMENT_ROOT'].'/reports/pvmotion/'.$filename ;
