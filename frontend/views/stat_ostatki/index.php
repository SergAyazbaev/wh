...
<div class="sprtype-index">
    ...
    <?= Html::a('Список количества накладных по Штрихкодам товара в EXCEL',
        ...
        'columns' => [
            ...
            [
                    ...
                    'content' => function($model) {
                        ...
                        //ddd($model);
                            ...
                            $url = Url::to(['/stat_ostatki/ost_element_one_sum?tabl=1&id='.$model->id.'&parent_id='.$model->parent_id ]);

                        $text_ret .= Html::a('Возвраты', $url, [
                                'class' => 'btn btn-success btn-xs',
                                'data-pjax' => 0,
                                'data-id' => $model->_id,
                                'target' => '_blank'
            ...
            [
                ...
                'content' => function ($model) {
                    ...
                    $url = Url::to(['/stat_ostatki/fast_turnover?id=' . $model->id]);

                    $text_ret .= Html::a('Возвраты за 3 мес', $url, [
                        'class' => 'btn btn-success btn-xs',
                        'data-pjax' => 0,
                        'data-id' => $model->_id,
                        'target' => '_blank'
