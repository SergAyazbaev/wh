...
//         '_id' => '5eba1a456e173874f165bc51'
//        'id' => 3273
//        'dt_create' => '30.04.2020 23:55:55'
//        'dt_create_timestamp' => 1588269355
//        'sklad_vid_oper' => 1
//        'sklad_vid_oper_name' => 'Заливка динамичная'
//        'wh_home_number' => 181
//        'empty_cs' => 0
//        'wh_destination' => 14
//        'wh_destination_element' => 181
//        'wh_destination_name' => 'City Bus ТОО'
//        'wh_destination_element_name' => '5005'
//        'array_tk_amort' => [
...
//$sharedStyleYellow = new PHPExcel_Style();
//$sharedStyleYellow->applyFromArray(
//    [
//        'borders' => [
...
//        $activeSheet->setSharedStyle($sharedStyle1, 'A' . ($num + 5) . ':E' . ($num + 5));

        $activeSheet
            ->getRowDimension($num + 5)
            ->setOutlineLevel(1)
            ->setVisible(false)
            ->setCollapsed(true);
