...
<style>
         ...
         .form-group.field-pvmobile-wh_top_name
        {
            display: none;
        }
    ...
    <div class="pv_motion_create_left">
        ...
        <?
            ...
            if ($model->dt_create)
                ...
                $date_now   = date("Y-m-d H:i:s",strtotime($model->dt_create));
            else
                $date_now   = date("Y-m-d H:i:s");
    ...
    <div class="pv_motion_create_right_center">
            ...
            echo '<div class="tree_land">';
                echo $form->field($model, 'type_action')->dropdownList(
                    \yii\helpers\ArrayHelper::map(frontend\models\Typeact::find()->all(), 'id', 'name'),
        ...
        // dd($model);
            ...
            echo '<div class="tree_land">';
                ...
                echo $form->field($model, 'wh_top')->dropdownList(
                 ...
                 echo $form->field($model, 'wh_top_name')
                 ->label('')->hiddenInput();

                 echo $form->field($model, 'wh_element')->dropdownList(
                     frontend\models\Sprwhelement::find()->where(['parent_id' => (integer)$model->wh_top])->select(['name'])->indexBy('name')->column(),
                    [
...
<a href="https://atandrastoth.co.uk/main/pages/plugins/codereader/"> WWWWWWWW</a>
<a href="https://www.xarg.org/project/jquery-webcam-plugin/"> WWWWWWWW</a>
...
$('#pvmobile-wh_top').change(function() {
    var  number = $(this).val();
    var  text = $('option[value='+number+']').text();
    
    	    $('#pvmobile-wh_top_name').val(text);
    ...
    $.ajax( {
		...
		//dataType: "json",		
		    ...
		    $('#pvmobile-wh_element').html('');
		    $('#pvmobile-wh_element').html(res);
